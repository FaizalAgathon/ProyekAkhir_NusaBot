...
@include('layouts/blocks/navigation-1')
...
@include('layouts/blocks/services-1')

@include('layouts/blocks/projects')

@include('layouts/blocks/testomonial-n-clients')

@include('layouts/blocks/newsletter')

@include('layouts/blocks/news')
