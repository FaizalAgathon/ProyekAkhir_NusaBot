...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="{{ route('pSekolah-index') }}" class="logo d-flex align-items-center">
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            ...
            <span class="d-none d-md-block dropdown-toggle ps-2">{{ Auth::guard('pSekolah')->user()->nama_ps }}</span>
          </a><!-- End Profile Iamge Icon -->

          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            <li class="dropdown-header">
              <h6>{{ Auth::guard('pSekolah')->user()->nama_ps }}</h6>
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center" href="{{ route('pSekolah-profile') }}">
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link {{ basename($_SERVER['REQUEST_URI']) != 'p-sekolah' ? 'collapsed' : '' }}"
          href="{{ url('/') }}">
      ...
      <li class="nav-item">
        ...
        <ul id="components-nav" class="nav-content collapse {{ $jurnalActive ?? '' }}" data-bs-parent="#sidebar-nav">
          @foreach ($listSiswa as $item)
            <li>
              <a href="{{ url('p-sekolah/jurnal/') . '/' . $item->id_plotting }}"
      ...
      <li class="nav-item">
        <a class="nav-link {{ $profile ?? 'collapsed' }}" href="{{ route('pSekolah-profile') }}">
          <i class="bi bi-person"></i>
          <span>Profile</span>
        </a>
